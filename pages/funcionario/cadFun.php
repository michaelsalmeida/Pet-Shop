    ...
    <div>
        <form action="<?php echo $procCadFunRoute; ?>" method="post">
            ...
            <input type="text" name="nome" id="nome" required autofocus
                placeholder="Digite o Nome do funcionário"><br><br>

            <label for="cpf">CPF: </label>
            <input type="text" name="cpf" pattern="[0-9]{11}" placeholder="Digite o CPF do funcionário"
                required><br><br>
            ...
            <input type="password" name="senha" placeholder="Digite a senha"
                pattern="^(?=.*[A-Z])(?=.*[a-z])(?=.*\d)(?=.*[^\w\s]).{8,}$" required><br><br>
