...
function gerarTabelaAni() {
    ...
    $header = "http://" . $_SERVER['SERVER_NAME'] . ":" . $_SERVER['SERVER_PORT'] . '/pages/clientes/animaisCli.php';
...
function gerarTabelaAgenCli() {
    require_once($_SERVER['DOCUMENT_ROOT'] . '/backend/conexao.php');
    $header = "http://" . $_SERVER['SERVER_NAME'] . ":" . $_SERVER['SERVER_PORT'] . '/pages/clientes/agendamentosCli.php';
...
function gerarTabelaDeleteFun() {
    require_once($_SERVER['DOCUMENT_ROOT'] . '/backend/conexao.php');
    $header = "http://" . $_SERVER['SERVER_NAME'] . ":" . $_SERVER['SERVER_PORT'] . '/pages/Jfuncionario/listarFuncionario.php';
